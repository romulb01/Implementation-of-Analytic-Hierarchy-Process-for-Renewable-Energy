...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ResumoGrupos = xlsread('Dados_de_entrada_Turbinas_Eolicas_Eixo_VERTICAL','ResumoEntrevistados','B1:B30'); 
...
CriteriosEolica = xlsread('Dados_de_entrada_Turbinas_Eolicas_Eixo_VERTICAL','CriteriosEolica','A1:D200'); %Contém dados que não são números
TecnicoTerritorialEolica=xlsread('Dados_de_entrada_Turbinas_Eolicas_Eixo_VERTICAL','TecnicoTerritorialEolica','A1:D200');
TecnicoInfraestruturaEolica=xlsread('Dados_de_entrada_Turbinas_Eolicas_Eixo_VERTICAL','TecnicoInfraestruturaEolica','A1:D200');
DadosRegioesEolica=xlsread('Dados_de_entrada_Turbinas_Eolicas_Eixo_VERTICAL','DadosRegioes','A1:B230');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [VetorprioridadesSubTecGerRegioesEolica, MatrizRCComparacaoSubTecGerEolica,a]=prioridade(MatrizAux,QuantSubTecGerEolica,QuantRegioes,RCref,s); %Intencionalmente colocou-se 1 para o cálculo de 1 único subcritério e quantidade de regiões em vez de quantidade de subcritérios, para o cálculo da prioridade dos dados das regiões.
...
Cont1=1;
 for Cont=1:QuantTotalEntrevistados
 VetorSubcriteriosConcatenadoEolica(:,[Cont1:Cont1+QuantCriteriosEolica-1])= horzcat(VetorprioridadesRegioesSocialEolica,  VetorprioridadesRegioesEconomicoEolica,  VetorprioridadesSubTecGerRegioesEolica, VetorSubTecTerritEolicaConcatenado(:,Cont), VetorSubTecInfraEolicaConcatenado(:,Cont));
